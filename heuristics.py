...
PickGiven5 = EvalStructure([(SymbolCountEvaluation(2, 1), 5), (FIFOEvaluation(), 1)])
"""
...
PickGiven2 = EvalStructure([(SymbolCountEvaluation(2, 1), 2), (FIFOEvaluation(), 1)])
"""
...
"""
    ...
    def testEvalStructure(self):
        ...
        """
        eval_funs = EvalStructure(
            [(SymbolCountEvaluation(2, 1), 2), (FIFOEvaluation(), 1)]
        )
