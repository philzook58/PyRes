...
class Literal(object):
    ...
    def __repr__(self):
        ...
        if self.isEquational():
            ...
            result = (
                term2String(termArgs(self.atom)[0])
                + op
    ...
    def isPureVarLit(self):
        ...
        """
        if self.isEquational():
            return termIsVar(termArgs(self.atom)[0]) and termIsVar(
                termArgs(self.atom)[1]
            )
        return False
    ...
    def isPropTrue(self):
        ...
        """
        return (self.isNegative() and atomIsConstFalse(self.atom)) or (
            self.isPositive() and atomIsConstTrue(self.atom)
        )
    ...
    def isPropFalse(self):
        ...
        """
        return (self.isNegative() and atomIsConstTrue(self.atom)) or (
            self.isPositive() and atomIsConstFalse(self.atom)
        )
    ...
    def isEqual(self, other):
        ...
        other.
        """
        return self.isNegative() == other.isNegative() and termEqual(
